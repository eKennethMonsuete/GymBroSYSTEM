...
namespace GymBroINFRA.Migrations
{
    ...
    [Migration("20240925221156_Update_Student_PersonalId_Nullable")]
    partial class Update_Student_PersonalId_Nullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Measures", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 25, 19, 11, 55, 871, DateTimeKind.Local).AddTicks(5596));
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Personal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 19, 11, 55, 869, DateTimeKind.Local).AddTicks(9551));
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 19, 11, 55, 868, DateTimeKind.Local).AddTicks(2183));

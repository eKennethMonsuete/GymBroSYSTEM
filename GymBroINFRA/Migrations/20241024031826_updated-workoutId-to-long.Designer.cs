...
namespace GymBroINFRA.Migrations
{
    ...
    [Migration("20241024031826_updated-workoutId-to-long")]
    partial class updatedworkoutIdtolong
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Measures", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 24, 0, 18, 25, 107, DateTimeKind.Local).AddTicks(243));
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Personal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 10, 24, 0, 18, 25, 105, DateTimeKind.Local).AddTicks(5106));
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 10, 24, 0, 18, 25, 103, DateTimeKind.Local).AddTicks(4462));
            ...
            modelBuilder.Entity("GymBroINFRA.Entity.Workout", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 10, 24, 0, 18, 25, 108, DateTimeKind.Local).AddTicks(1611));
